...
public class JSONArray implements Iterable<Object> {
  ...
  public Writer write(Writer writer, int indentFactor, int indent) throws JSONException {
    return write(writer, indentFactor, indentFactor, true);
  }

  public Writer write(Writer writer, int indentFactor, int indent, boolean newline) throws JSONException {
    try {

      for (Object o : this.myArrayList ) {
        if (o instanceof JSONObject || (o instanceof JSONArray && indent < indentFactor * 4)) {
          newline = true;
        }
      }
      ...
      if (length == 1) {
        ...
        try {
          JSONObject.writeValue(writer, this.myArrayList.get(0), indentFactor, newindent);
