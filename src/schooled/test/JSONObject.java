...
public class JSONObject {
  ...
  static final Writer writeValue(Writer writer, Object value, int indentFactor, int indent) throws JSONException, IOException {
    if (value != null && !value.equals((Object)null)) {
      ...
      if (value instanceof JSONString) {
        ...
        ((JSONArray)value).write(writer, indentFactor, indent, indentFactor > 2);
      } else if (value instanceof Map) {
        Map<?, ?> map = (Map)value;
        (new JSONObject(map)).write(writer, indentFactor, indent);
      } else if (value instanceof Collection) {
        Collection<?> coll = (Collection)value;
        (new JSONArray(coll)).write(writer, indentFactor, indent, indentFactor > 2);
      } else if (value.getClass().isArray()) {
        (new JSONArray(value)).write(writer, indentFactor, indent, indentFactor > 2);
      } else {
  ...
  public Writer write(Writer writer, int indentFactor, int indent) throws JSONException {
    return write(writer, indentFactor, indent, true);
  }

  public Writer write(Writer writer, int indentFactor, int indent, boolean newline) throws JSONException {
    try {
...
//        }
  ...
  public Map<String, Object> toMap() {
    ...
    Entry entry;
    Object value;
    for(Iterator var2 = this.entrySet().iterator(); var2.hasNext(); results.put(
